...
(function ($) {
	...
	$('.mu-skill-progress-bar').appear(function () {
		...
		$('.mu-neuro-symbolic-bar').LineProgressbar({
			percentage: 95,
			triggerOnce: true
		});

		$('.mu-deep-learning-bar').LineProgressbar({
			percentage: 90,
			triggerOnce: true
		});

		$('.mu-hft-bar').LineProgressbar({
			percentage: 88,
			triggerOnce: true
		});
		...
		$('.mu-financial-bar').LineProgressbar({
			percentage: 85,
			triggerOnce: true
		});

		$('.mu-research-bar').LineProgressbar({
			percentage: 90,
			triggerOnce: true
		});
